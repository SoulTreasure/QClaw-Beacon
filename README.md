...
## Beacon 核心优势 | Core Advantages

- ✅ **普通人 5 分钟能搭起来** —— 无需公网 IP、无需云服务器、无需域名，一台本地电脑即可
- ✅ **更省 Tokens** —— 轮询攒消息批量处理，同样的多轮对话消耗更少（对比实时响应方案），更具性价比
- ✅ **断线无忧** —— 轮询机制天然容错，断网断线 2 分钟后自动重来，无需任何重连逻辑
- ✅ **三平台完整安装文档** —— Windows 任务计划程序 / macOS & Linux cron，全部覆盖
- ✅ **你的龙虾有自己的记忆** —— 飞书 AI 通用回答，龙虾用自己的记忆和上下文，回复更懂你
- ✅ **Append-only 崩溃可恢复** —— 消息只追加不修改，崩溃后数据不丢失

> 💡 **核心理念**：不是不能用高大上的技术，是用最简单的工具解决真实的问题。简单高效，才是真正的厉害。
